...
public class BrandDtoRequest {
    @NotBlank(message = Constants.EXCEPTION_BRAND_NAME_NULL)
    ...
    @NotBlank(message = Constants.EXCEPTION_BRAND_DESCRIPTION_NULL)
    ...
    public BrandDtoRequest(String name, String description) {
